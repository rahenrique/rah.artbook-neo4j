...
from artbook.resources.artist import Artist, ArtistList, Artwork, ArtworkList, \
    ArtworkAuthorship, ArtistAuthorship, ArtworkSimilarityList, \
    Event, EventList
...
def create_app(test_config=None):
    ...
    api.add_resource(ArtworkSimilarityList, '/api/artworks/<string:id>/similar/', resource_class_kwargs={'db': db})
